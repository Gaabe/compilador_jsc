...
//REVISAR. ESSES PRINTS ESTAO ESTRANHOS.
//UnOp        = '-'  | '!'
...
//DUVIDA Devo colocar os cochete aqui, ou o bison cuida da precedencia?
...
dec_node::dec_node(float value) {num = value;}
...
//FuncCall    = ID '(' ArgList? ')'
funccall_node::funccall_node(string name, arglist_node *argumento) : id(name), arg(argumento) {}
...
void test1(){
    ...
    exp_node *op3 = new plus_node(new dec_node(3),new dec_node(5));
...
void test2(){
    ...
    stmts2->push_back(new assignment_stmt("a", new dec_node(3)));
    
    exp_node *op3 = new id_node("a");
    exp_node *op4 = new dec_node(2);
